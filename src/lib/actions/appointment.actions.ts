...
const { NEXT_APPOINTMENT_COLLECTION_ID, NEXT_DATABASE_ID } = process.env;
    ...
    const smsMessage = `
        ...
        ${
          type === "schedule"
            ...
            : `We regret to inform you that your appointment has been cancelled for the following resaon: ${appointment.cancellationReason}`
        }
        `;
